			  ...
			  <div class="row">
				...
				-->	
					...
					<ol class="breadcrumb">
						...
						<li><i class="fa fa-laptop"></i>List Cameras</li>
					</ol>
				</div>
			</div>
								...
								<ul class="nav top-menu">                    
									<li>
										<form class="navbar-form">
											<input class="form-control" placeholder="Search Cameras" type="text">
										</form>
									</li>
								</ul>
								<!--  search form end -->                
						...
						<div class="panel-body">
							<table>
								...
								/*
									...
									echo ("<tbody>");
									echo ("<tr> <th>IP</th><th>VISÃO</th><th>STATUS</th><th>SIGLA LOJA</th><th>NOME LOJA</th></tr>");
									foreach ($cameras as $linha)
									{
										echo("<tr style ='cursor:hand' onclick=location.href='alterar_camera.php?btb_cod=".$linha[0]."&btb_email=".$linha[1]."'>
												  <td>".$linha[1]."</td>
												  <td>".$linha[2]."</td>										  										 
												  <td>".$linha[3]."</td>
												  <td>".$linha[4]."</td>
