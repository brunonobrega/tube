			  ...
			  <div class="row">
				...
				-->	
					...
					<ol class="breadcrumb">
						...
						<li><i class="fa fa-laptop"></i>Cameras</li>
					</ol>
				</div>
			</div>
								...
								<ul class="nav top-menu">                    
									<li>
										<form class="navbar-form">
											<input class="form-control m-bot15" placeholder="Search" type="text">
										</form>
									</li>
								</ul>
								<!--  search form end -->                
						...
						<div class="panel-body">
							<table>
								...
								<?php
									...
									$cams = new Acam();
									$listcams = $cams->Listar($idlj);
				
									echo ("<table width = '900' border ='1' class='table table-striped table-advance table-hover'>");
									echo ("<tbody>");
									echo ("<tr> <th>ID_CAM</th><th>NAME</th><th>PLACE</th><th>DELETE</th></tr>");
									foreach ($listcams as $linha)
									{
										echo("<tr><td>".$linha[0]."</td>
												  <td>".$linha[2]."</td>										  										 
												  <td>".$linha[3]."</td>
												  <td><a href='excluir_camera.php?cod=".$linha[0]."' class='btn btn-danger'><i class='icon_close_alt2'></i></a></td>
										      </tr>");
									}
									echo ("</tbody>");
									echo ("</table>");
