...
if ($_SESSION['acessoUsuario'] != 5){
	$_SESSION['alteraUsuario'] = $_SESSION['emailUsuario'];
				...
				<div class="col-lg-9 col-md-12" style="width:100%;">	
					<div class="panel panel-default">
						<div class="panel-heading">
							<h2><i class="fa fa-flag-o red"></i><strong>Users</strong></h2>
						</div>
						...
						<div class="panel-body">
							<table>
								...
								//Mesmo código do Openflix
									...
									echo ("<tbody>");
									echo ("<tr> <th>ID</th><th>EMAIL</th><th>PROFILE</th><th>STATUS</th></tr>");
									foreach ($usuarios as $linha)
									{
										echo("<tr style ='cursor:hand' onclick=location.href='alterar_usuario.php?btb_cod=".$linha[0]."&btb_email=".$linha[1]."'>
												  <td>".$linha[0]."</td>
												  <td>".$linha[1]."</td>
												  <td>".$linha[3]."</td>
												  <td>".$linha[4]."</td>
