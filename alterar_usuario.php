...
if (!empty($_GET['btb_email'])){
	$_SESSION['alteraUsuario'] = $_GET['btb_email'];
}
?>
			  ...
			  <div class="row">
				...
				-->	
					...
					<ol class="breadcrumb">
						...
						<li><i class="fa fa-laptop"></i>Alterar Usuário</li>
					</ol>
				</div>
			</div>
				...
				<div class="col-lg-9 col-md-12" style="width:100%;">	
					<div class="panel panel-default">
						<div class="panel-heading">
							<h2><i class="fa fa-flag-o red"></i><strong>Alterar Usuário</strong></h2>
						</div>
						
							<form class="login-form" action="alt_usuario.php" method="post">
								<div class="login-wrap-2">
									...
									<p class="login-img"><i class="icon_lock_alt"></i> <b>Alterar Usuário</b></p>
									
									<label>Usuário</label>
									<div class="input-group">
									  <span class="input-group-addon"><i class="icon_profile"></i></span>
									  <select class="form-control" name="usuario" placeholder="Perfil" readonly="readonly" required>
											<option selected="selected"><?php echo $_SESSION['alteraUsuario'];?></option>
											</select>
									...
									<div class="input-group">
										<span class="input-group-addon"><i class="icon_key_alt"></i></span>
										<input type="password" class="form-control" name="confNovaSenha" placeholder="Confirmar Nova Senha" required>
									</div>
									...
									<button class="btn btn-danger btn-lg btn-block" type="submit" onclick="window.location.href='listar_usuario.php'">Voltar</button>
								</div>
							</form>
                <!-- statics end -->
