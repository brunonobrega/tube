								...
								<ul class="nav top-menu">                    
									<li>
										<form class="navbar-form">
											<input class="form-control m-bot15" placeholder="Search User" type="text">
										</form>
									</li>
								</ul>
								<!--  search form end -->                
						...
						<div class="panel-body">
							...
							<table>
								...
								<?php
									...
									echo ("<tbody>");
									echo ("<tr> <th>EMAIL</th><th>PROFILE</th><th>DELETE</th>");
									foreach ($usuarios as $linha)
									{
										echo("<tr><td>".$linha[1]."</td>										  										 
												  <td>".$linha[3]."</td>
												  <td><a href='deleta_usuario.php?cod=".$linha[0]."' class='btn btn-danger'><i class='icon_close_alt2'></i></a></td>
										      </tr>");
									}
									echo ("</tbody>");
									echo ("</table>");
