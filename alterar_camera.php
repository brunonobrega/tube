...
$consulta = new Acam();
$camera = $consulta->Buscar($idcam);

$idlj = $camera[0][1];
$nome_cam = $camera[0][2];
$visao_cam = $camera[0][3];
$url_cam = $camera[0][4];
		  ...
		  <div class="row">
				<div class="col-lg-12">					
					<ol class="breadcrumb">
						...
						<li><i class="fa fa-laptop"></i>Update Camera</li>	
					</ol>
				</div>
			</div>
              <!-- Form validations -->              
				...
				<div class="col-lg-9 col-md-12" style="width:100%;">	
					<div class="panel panel-default">
						<div class="panel-heading">
							<h2><i class="fa fa-flag-o red"></i><strong>Update Camera</strong></h2>
						</div>
						  
                          <div class="panel-body">
                              <div class="form">
                                  <form class="form-validate form-horizontal" method="post" action="atualiza_camera.php">
                                      <div class="form-group ">
                                          <label for="ccomment" class="control-label col-lg-2">Store Name <span class="required">*</span></label>
											...
											<input class="form-control " id="cname" type="hidden" value="<?php echo $idcam;?>" name="IdCam" required />								
									  ...
									  <div class="form-group ">
                                          <label for="ccomment" class="control-label col-lg-2">Camera Place <span class="required">*</span></label>
                                          <div class="col-lg-10">
											  <input class="form-control " id="cname" type="text" value="<?php echo $visao_cam;?>" name="VisaoCamera" />
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-4">
                                              <input class="form-control " id="cname" type="text" value="<?php echo $nome_cam;?>" name="NomeCamera" required />
                                          </div>
                                      </div>									  
                                      <div class="form-group ">
                                          <label for="cname" class="control-label col-lg-2">URL<span class="required">*</span></label>
                                          <div class="col-lg-4">
                                              <input class="form-control " id="cname" type="text" value="<?php echo $url_cam;?>" name="Url" required />                                         										  								
                                          </div>
                                      </div>
