						...
						<section id="videos">
							<div class="panel-body-map" style="height:660px;">
								<center>
									...
									<iframe id="cameraUm" src="http://52.44.225.241/stream.php?camera=11"  frameborder="0" scrolling="NO" width="420px" height="280px;" style="display:inline;"></iframe>
									
									<iframe id="cameraUm" src="http://52.44.225.241/stream.php?camera=12"  frameborder="0" scrolling="NO" width="420px" height="280px;" style="display:inline;"></iframe>
									
									<iframe id="cameraUm" src="http://52.44.225.241/stream.php?camera=13"  frameborder="0" scrolling="NO" width="420px" height="280px;" style="display:inline;"></iframe>
									
									<iframe id="cameraUm" src="http://52.44.225.241/stream.php?camera=14"  frameborder="0" scrolling="NO" width="420px" height="280px;" style="display:inline;"></iframe>
									
									<iframe id="cameraUm" src="http://52.44.225.241/stream.php?camera=15"  frameborder="0" scrolling="NO" width="420px" height="280px;" style="display:inline;"></iframe>
									
									<iframe id="cameraUm" src="http://52.44.225.241/stream.php?camera=16"  frameborder="0" scrolling="NO" width="420px" height="280px;" style="display:inline;"></iframe>
									
									<!--
									<video width="420" autoplay id="cameraDois" poster="videos/bk.jpg" loop style="display:inline;">
										<source src="videos/camera.mp4" type="video/mp4">
									</video>
									
									<video width="420" autoplay id="cameraTres" poster="videos/bk.jpg" loop style="display:inline;">
										<source src="videos/camera.mp4" type="video/mp4">
									</video>
									<video width="420" autoplay id="cameraQuatro" poster="videos/bk.jpg" loop style="display:inline;">
										<source src="videos/camera.mp4" type="video/mp4">
									</video>
									<video width="420" autoplay id="cameraCinco" poster="videos/bk.jpg" loop style="display:inline;">
										<source src="videos/camera.mp4" type="video/mp4">
									</video>
									<video width="420" autoplay id="cameraSeis" poster="videos/bk.jpg" loop style="display:inline;">
										<source src="videos/camera.mp4" type="video/mp4">
									</video>
									-->
								</center>
