				   ...
				   <div class="col-lg-9 col-md-12">
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h2><i class="fa fa-map-marker red"></i><strong>Regiões</strong></h2>
							...
							<div class="panel-body-map">
								<?php 
									...
									echo "
									<svg id='map2' xmlns='http://www.w3.org/2000/svg' xml:space='preserve' width='150%' height='90%' version='1.1' style='shape-rendering:geometricPrecision; text-rendering:geometricPrecision; image-rendering:optimizeQuality; fill-rule:evenodd; clip-rule:evenodd'
