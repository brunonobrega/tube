		   ...
		   <div class="col-lg-9 col-md-12">
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h2><i class="fa fa-map-marker red"></i><strong>Stores</strong></h2>
							<div class="panel-actions">
								<!--a href="dashboard.php#" class="btn-setting">&nbsp País &nbsp </a-->
								<a href="javascript:window.history.go(-3)" class="btn-setting">&nbsp States &nbsp </a>
								<a href="javascript:window.history.go(-2)" class="btn-setting">&nbsp Regions &nbsp </a>
								<a href="javascript:window.history.go(-1)" class="btn-setting">&nbsp Cities &nbsp </a>
						...
						<div class="panel-body-map">
							...
							xmlns:xlink="http://www.w3.org/1999/xlink">
								...
								<?php 
									...
									$url = "mapas/regioes-".$estado."/cidades/".$cidade.".php";
